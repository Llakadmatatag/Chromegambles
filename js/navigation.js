...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tabs.forEach(tab => {
        tab.addEventListener('click', async () => {
            ...
            // For RAIN.GG and DICEBLOX, use multiLeaderboardService
            if ((platform === 'raingg' || platform === 'diceblox') &&
                window.multiLeaderboardService &&
                typeof window.multiLeaderboardService.renderLeaderboard === 'function') {
                try {
                    await window.multiLeaderboardService.renderLeaderboard(
                        platform,
                        `${platform}-top-winners`,
                        `${platform}-other-winners`
                    );
                } catch (error) {
                    console.error(`Error loading ${platform} leaderboard with multi-leaderboard service:`, error);
                }
            }
            // For other platforms, use the regular leaderboardService
            else if (window.leaderboardService && typeof window.leaderboardService.renderLeaderboard === 'function') {
                try {
